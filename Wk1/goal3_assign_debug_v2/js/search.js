...
// Validates search query
    var validate = function(query){                                             // this is an anonymous functions.
...
// save a lowercase variable of the search keyword
            for (var ii = 0, jj = queryArray.length; ii < jj; ii++) {                  // for loop loops through all characters in the users query
                var qItem = queryArray[ii].toLowerCase();                       // variable to store query in array and in all lower case
...
// THE LINE DIRECTLY BELOW IS CORRECT
            document.forms[0].onsubmit = function() {                           // function
                ...
                validate(query); // call validate function with query as its parameter
